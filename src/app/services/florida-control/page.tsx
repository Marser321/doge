...
export default function FloridaControlPage() {
  ...
  const handleSubmit = () => {
    ...
    const message = encodeURIComponent(
      `Hola DOGE.S.M LLC, solicito un estimado para Control Florida Anti-Humedad.\n\n` +
      `📸 Descripción: ${desc}\n` +
      `👤 Nombre: ${name}\n` +
      `📞 Contacto: ${contact}\n` +
      `📍 Dirección: ${address}\n` +
      ...
      <div className="min-h-screen bg-background transition-colors duration-500 font-sans text-foreground flex items-center justify-center relative overflow-hidden">
        ...
        >
          ...
          <p className="text-accent text-lg font-medium leading-relaxed mb-12">
            {lang === 'es'
              ? 'Tu solicitud ha sido enviada por WhatsApp. Nuestro equipo te contactará con un plan de acción anti-humedad personalizado.'
              : 'Your request has been sent via WhatsApp. Our team will contact you with a personalized anti-moisture action plan.'}
          </p>
  ...
  return (
    <div className="min-h-screen bg-background transition-colors duration-500 font-sans text-foreground selection:bg-accent/30 overflow-hidden relative">
      ...
      {/* Background */}
      <div className="absolute top-[-10%] right-[-10%] w-[min(800px,80vw)] h-[min(800px,80vw)] bg-emerald-500/5 rounded-full blur-[120px] pointer-events-none"></div>
      <div className="absolute bottom-[-10%] left-[-10%] w-[min(600px,60vw)] h-[min(600px,60vw)] bg-teal-500/5 rounded-full blur-[120px] pointer-events-none"></div>
      ...
      <div className="max-w-4xl mx-auto px-6 py-8 md:py-16 relative z-10">
        ...
        >
          <div className="inline-flex rounded-2xl border border-accent/10 bg-foreground/5 p-1.5">
            ...
            >
              <Camera className="w-4 h-4" /> {t('fc.methodPhotos')}
            </button>
            <button
            ...
            >
              <FileText className="w-4 h-4" /> {t('fc.methodText')}
            </button>
          </div>
        </motion.div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              ...
              {method === 'photos' ? (
                ...
                >
                  ...
                  <textarea
                    ...
                    placeholder={t('fc.textPlaceholder')}
                    rows={8}
          ...
          >
            <div>
              <label className="text-[10px] font-black uppercase tracking-[0.3em] text-accent mb-3 block">{t('wc.nameLabel')}</label>
            ...
            <div>
              <label className="text-[10px] font-black uppercase tracking-[0.3em] text-accent mb-3 block">{t('wc.contactLabel')}</label>
            ...
            <div>
              <label className="text-[10px] font-black uppercase tracking-[0.3em] text-accent mb-3 block">{t('wc.addressLabel')}</label>
            ...
            <div>
              <label className="text-[10px] font-black uppercase tracking-[0.3em] text-accent mb-3 block">{t('wc.notesLabel')}</label>
            ...
            <div className="bg-accent/5 p-4 rounded-xl border border-accent/10 flex items-start gap-3">
              ...
              <span className="text-[10px] font-bold text-accent uppercase tracking-widest leading-relaxed">
                {lang === 'es'
                  ? 'Recibirás un plan de acción anti-humedad personalizado por WhatsApp. Sin compromiso.'
                  : 'You\'ll receive a personalized anti-moisture action plan via WhatsApp. No commitment.'}
              </span>
            </div>
          </motion.div>
        </div>
